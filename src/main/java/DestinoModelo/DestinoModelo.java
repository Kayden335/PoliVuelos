 ...
 */
package DestinoModelo;

/**
 *
 * @author USUARIO
 */
public class DestinoModelo {
    ...
    public void modificarAdultoMayor(int cantidad) {
        if (cantAdultosMayores + cantidad >= 0) cantNinios += cantidad;
    }
    
    public void modificarDiscapacitado(int cantidad) {
        if (cantDiscapacitados + cantidad >= 0) cantNinios += cantidad;
    }
